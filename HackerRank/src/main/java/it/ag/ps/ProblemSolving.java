...
//        singlyLinkedListNode2.next = singlyLinkedListNode3;
        ...
        // printLinkedList(deleteNode(singlyLinkedListNode1, 2));

        // reversePrint(singlyLinkedListNode1);
//        printLinkedList(reverse(singlyLinkedListNode1));

        SinglyLinkedListNode singlyLinkedListNodeA1 = new SinglyLinkedListNode(1);
        SinglyLinkedListNode singlyLinkedListNodeA2 = new SinglyLinkedListNode(2);
        singlyLinkedListNodeA1.next = singlyLinkedListNodeA2;

        SinglyLinkedListNode singlyLinkedListNodeB1 = new SinglyLinkedListNode(1);

        if ( compareLists(singlyLinkedListNodeA1, singlyLinkedListNodeB1) ) System.out.println("1"); else System.out.println("0");
